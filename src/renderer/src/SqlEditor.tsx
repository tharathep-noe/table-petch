...
interface Props {
  connectionId: string
  /** Controlled editor text (lifted to App so table clicks can prefill it). */
  value: string
  ...
  return (
    <div className="border-b border-border">
      ...
      <div className="flex items-center gap-2 px-2 py-1.5 bg-panel">
        <button
          className="bg-accent text-white rounded px-3 py-1 cursor-pointer disabled:opacity-50"
          onClick={run}
          disabled={running}
